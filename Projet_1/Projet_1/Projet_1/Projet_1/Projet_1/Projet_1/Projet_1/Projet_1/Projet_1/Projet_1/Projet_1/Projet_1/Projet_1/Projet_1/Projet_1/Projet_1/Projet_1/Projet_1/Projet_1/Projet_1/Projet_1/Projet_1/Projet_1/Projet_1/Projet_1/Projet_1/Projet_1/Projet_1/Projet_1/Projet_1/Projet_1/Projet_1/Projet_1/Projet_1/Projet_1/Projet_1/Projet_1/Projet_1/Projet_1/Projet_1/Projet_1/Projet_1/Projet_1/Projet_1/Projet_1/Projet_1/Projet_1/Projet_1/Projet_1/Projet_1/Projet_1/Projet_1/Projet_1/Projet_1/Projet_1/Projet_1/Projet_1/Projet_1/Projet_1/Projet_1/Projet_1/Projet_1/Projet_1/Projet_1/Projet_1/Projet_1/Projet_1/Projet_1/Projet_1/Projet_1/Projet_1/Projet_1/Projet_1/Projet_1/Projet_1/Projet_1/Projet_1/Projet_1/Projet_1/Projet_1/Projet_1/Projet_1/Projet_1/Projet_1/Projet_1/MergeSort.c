...
/* ------------------------------------------------------------------------- *
 * Merge 2 given subtable A[p;q] & A[q+1;r] into one big table A[p;r]
 * PARAMETERS
 * array        The array to treat
 * p            Beginning of the array
 * q            End of the first sub array
 * r            End of the second sub array and of the array
 * ------------------------------------------------------------------------- */
void merge(int* array, int p, int q, int r);

/* ------------------------------------------------------------------------- *
 * Implementation of the Merge Sort algorithm recursively
 * PARAMETERS
